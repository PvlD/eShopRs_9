...
impl AtRule {
    ...
    pub(crate) fn new(token_stream: TokenStream, class: &Class, is_proc_macro: bool) -> (AtRule, HashSet<String>) {
        let mut css_at_rule = AtRule { rules: vec![], at_rules: vec![] };
    ...
    fn parse(&mut self, token_stream: TokenStream, class: &Class, is_proc_macro: bool) -> HashSet<String> {
            ...
            match tt {
                TokenTree::Group(t) => {
                    ...
                    if t.delimiter() == Delimiter::Brace {
                        ...
                        if at_rule.contains("@page") || at_rule.contains("@font-face") || at_rule.contains("keyframes") || at_rule.contains("@counter-style") || at_rule.contains("@font-feature-values") || at_rule.contains("@property") {
                        ...
                        add_spaces(&mut at_rule, t.span(), &mut pre_line, &mut pre_col, is_proc_macro);
                        at_rule.push_str(&parse_group(t, is_proc_macro));
                    }
                }
                TokenTree::Ident(t) => {
