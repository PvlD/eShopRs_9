...
fn test_15() {
    ...
    assert_eq!(style, r#"a[title="I am ,testing"].test{background-color: yellow;}"#);
}
...
fn test_18() {
    ...
    assert_eq!(style, r#"div[class^="test"].test{background-color: yellow;}"#);
}
...
fn test_20() {
    ...
    assert_eq!(style, "div.test [class$=test].test{background-color: yellow;}");
}
...
fn test_28() {
    ...
    assert_eq!(style, r#"@import url("landscape.css") screen and (orientation: landscape);"#);
...
fn test_29() {
    ...
    assert_eq!(style, r#"@namespace svg url("http://www.w3.org/2000/svg");"#);
...
fn test_30() {
    ...
    assert_eq!(style, "@supports (display: flex){@media screen and (min-width: 900px){article.test{display: flex;}}}");
}
...
fn test_31() {
    ...
    assert_eq!(style, r#"@document url("https://www.example.com/"){h1.test{color: green;}}"#);
}
...
fn test_32() {
    ...
    assert_eq!(style, r#"@page{size: A4;margin: 10%;@top-left-corner {content: "Page " counter(page);}}"#);
}
...
fn test_34() {
    ...
    assert_eq!(style, "@keyframes spin1{to {-webkit-transform: rotate(360deg);}}");
}
...
fn test_35() {
    ...
    assert_eq!(style, "@-webkit-keyframes spin2{to {-webkit-transform: rotate(360deg);}}");
...
fn test_36() {
    ...
    assert_eq!(style, r#"@counter-style thumbs{system: cyclic;symbols: "\1F44D";suffix: " ";}"#);
}
...
fn test_37() {
    ...
    assert_eq!(style, r#"@font-feature-values Font One{@styleset {nice-style: 12;}}"#);
...
fn test_38() {
    ...
    assert_eq!(style, r#"@property --property-name{syntax: "<color>";inherits: false;initial-value: #c0ffee;}"#);
...
fn test_39() {
    ...
    assert_eq!(style, r#"@layer framework{@layer layout{p.test{margin-block: 1rem;font: 0.9em/1.2 Arial, Helvetica, sans-serif;content: "\hello";content: "\hello";}}}"#);
}
...
fn test_42() {
    ...
    assert_eq!(style, ":root{--blue: #1e90ff;}body.test{background-color: var(--blue);}");
}
...
fn test_43() {
    ...
    assert_eq!(style, "#container.test{--first-color: #290;}#thirdParagraph.test{background-color: var(--first-color);color: var(--second-color);}");
}
...
fn test_50() {
    ...
    assert_eq!(style, "@supports (display: flex){.flex-container.test>.test{text-shadow: 0 0 2px blue;float: none;}.flex-container.test{display: flex;}}");
}
...
fn test_52() {
    ...
    assert_eq!(style, ".unitToggle.test .onDisplay,.unitToggle.test .offDisplay{color: black;}");
}
...
fn test_53() {
    ...
    assert_eq!(style, ".wingman.test svg[role=graphics-symbol]{width: 100%;}");
}
...
fn test_54() {
    ...
    assert_eq!(style, ".errorSign.test{transform-box: fill-box;transform-origin: center;scrollbar-width: 1px;scrollbar-color: red;}");
}
